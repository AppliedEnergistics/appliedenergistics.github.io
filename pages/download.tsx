function Download() {
    return <>
        ...
        <a className="button" href="https://www.curseforge.com/minecraft/mc-mods/applied-energistics-2/files/all">
            <span className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2017 853 43 23">
                <path d="M-2005.7,853l0.7,3c-3.5,0-12,0-12,0s0.2,0.9,0.3,1c0.3,0.5,0.6,1.1,1,1.5c1.9,2.2,5.2,3.1,7.9,3.6
